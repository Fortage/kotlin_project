package com.fortage.tic_tac_toe
...
class WinPage2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_win_page2)
...
//            super.onBackPressed()
            val intent = Intent(this, SinglePlayerActivity1::class.java)
